...
\n  $Header: Y:\cvs_public/AVR/Template/CVS_doxygen.c,v 1.2 2005/04/23 08:29:15 zoubata Exp $
\n  $Date: 2005/04/23 08:29:15 $
\n  $Revision: 1.2 $

\n  $History: CVS_doxygen.c $
   
\n 
\n  $Log: CVS_doxygen.c,v $
\n  Revision 1.2  2005/04/23 08:29:15  zoubata
